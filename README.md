...
<tr><td>Stock Components </td><td><strong>✔</strong></td><td>with Drupal support built-in (https://github.com/fourkitchens/emulsify/tree/hotfix/remove-pls-comparison#emulsifys-built-in-components-with-drupal-support)</td></tr>
